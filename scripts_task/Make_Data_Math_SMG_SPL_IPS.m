...
%Math_Regions_2 = [103:108];%FG
%Math_Regions_2 = [135:136, 143:144];%IPL
Math_Regions_2 = [129:130, 133:134, 137:138];%IPS
%Math_Regions_2 = [131:132, 125:128];%SPL
%Math_Regions_2 = [139:142, 145:146];%SMG
%Math_Regions_2 = [215:218];%HIPP
...
%save variables
StrSaveData = '/oak/stanford/groups/menon/projects/a1das/2018_ECoG_Math_Project/scripts/Release_20171012_scripts/scripts_task/Generated_Data/IPS_SPL_SMG/';
StrSaveSubjInd = '/oak/stanford/groups/menon/projects/a1das/2018_ECoG_Math_Project/scripts/Release_20171012_scripts/scripts_task/Subject_Indices/IPS_SPL_SMG/';
...
if (~isempty(SubjInd))
            ...
            for i_RegX = 1:length(RegXIdx)
                ...
                if ((ChIDNum1~=0) && (ChIDNum2~=0))
                    ...
                    if ((cell2mat(EEGoffset(Iscorrect_Correct(j)+1)) - cell2mat(EEGoffset(Iscorrect_Correct(j))) >= Post_Stim_Samples) &&  (cell2mat(EEGoffset(Iscorrect_Correct(j)+1)) - cell2mat(EEGoffset(Iscorrect_Correct(j))) < Discard_Samples))
                        ...
                        DataTemp = A(cell2mat(EEGoffset(Iscorrect_Correct(j)))+1:cell2mat(EEGoffset(Iscorrect_Correct(j))) + Post_Stim_Samples);
    ...
    save(strcat(StrSaveData,'Correct_ITGIPS_ITG.mat'),'RegXData');
    save(strcat(StrSaveData,'Correct_ITGIPS_IPS.mat'),'RegYData');
    ...
    clear SubjInd
    SubjInd = SubjIndTemp;
    save(strcat(StrSaveSubjInd,'ITGIPS_Correct.mat'),'SubjInd');

         ...
         for j=1:NElecX
             ...
             for k=1:NElecY
                 ...
                 for i_Epoch=1:NEpochs
                     ...
                     Ch1filtscore_global = zscore(BandFilt_1);
                     Ch2filtscore_global = zscore(BandFilt_2);
                     
                     Tot_Len = length(Ch1filtscore_global);
                     ...
                     for i_Rand = 1:N_Rand
                         ...
                         Ch1filtscore = Ch1filtscore_global(rand_ind);
                         Ch2filtscore = Ch2filtscore_global(rand_ind);

...
%Math_Regions_2 = [125:134, 137:138, 139:142, 145:146];%IPS
...
if (~isempty(SubjInd))
    ...
    save(strcat(StrSaveData,'Correct_ITGFG_ITG.mat'),'RegXData');
    save(strcat(StrSaveData,'Correct_ITGFG_FG.mat'),'RegYData');
    ...
    clear SubjInd
    SubjInd = SubjIndTemp;
    save(strcat(StrSaveSubjInd,'ITGFG_Correct.mat'),'SubjInd');

...
if (~isempty(SubjInd))
    ...
    save(strcat(StrSaveData,'Correct_ITGOthers_ITG.mat'),'RegXData');
    save(strcat(StrSaveData,'Correct_ITGOthers_Others.mat'),'RegYData');
    ...
    clear SubjInd
    SubjInd = SubjIndTemp;
    save(strcat(StrSaveSubjInd,'ITGOthers_Correct.mat'),'SubjInd');
